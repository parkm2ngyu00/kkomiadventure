...
window.onload = function () {
	...
	if (currentItem) {
		...
		document.getElementById("location").dataset.fullDescription =
		...
		// 오디오 파일 경로 설정
		var audioOneSource = currentItem.sound[0]; // 오디오 파일 경로 설정
		var audioTwoSource = currentItem.sound[1];
		var audioThreeSource = currentItem.sound[2];

		// 오디오 요소에 오디오 파일 설정
		document.getElementById("audioOne").src = audioOneSource;
		document.getElementById("audioTwo").src = audioTwoSource;
		document.getElementById("audioThree").src = audioThreeSource;
